...
* annotator.comment.1: Comments by the annotator
* annotator.comment.2: Comments by the annotator
...
ufor_step2_clean <- ufor_step2 %>%
  ...
  dplyr::rename(`Action Format` = action.format,
                ...
                `Annotator Comment 1` = annotator.comment.1,
                `Annotator Comment 2` = annotator.comment.2,) %>%
  # renaming levels
...
c. FP created through script (N=6) (i.e. *or not* (instance 42, 76, 459), *or no* (instance 78), *or so* (instance 22), *or two* (instance 41))
